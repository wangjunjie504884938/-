...
public class PlayerCombatController : MonoBehaviour
{
    ...
    private void ApplyRuneEffectsToEnemy(SkillData skill, EnemyController enemy)
    {
        ...
        // ElementConvert: apply random element effect
    ...
    /// <summary>符文吸血（独立于基础生命偷取）</summary>
    ...
    /// <summary>在目标区域生成燃烧地面（持续伤害区域）</summary>
    ...
    /// <summary>战士旋风斩变异：烈焰旋风、雷鸣斩、吸引旋风。</summary>
